package org.fzkj.config.mybatis.aspect;
...
import org.fzkj.common.aspect.annotation.DynamicTable;
import org.fzkj.common.constant.CommonConstant;
import org.fzkj.common.util.SpringContextUtils;
import org.fzkj.config.mybatis.ThreadLocalDataHelper;
...
public class DynamicTableAspect {
     ...
     * 定义切面拦截切入点
     */
    @Pointcut("@annotation(org.fzkj.common.aspect.annotation.DynamicTable)")
