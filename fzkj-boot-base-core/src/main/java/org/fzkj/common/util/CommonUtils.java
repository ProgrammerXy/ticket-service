...
import org.fzkj.common.util.filter.FileTypeFilter;
import org.fzkj.common.util.oss.OssBootUtil;
...
public class CommonUtils {
    ...
    public static String uploadLocal(MultipartFile mf, String bizPath, String uploadpath) {
        try {
            ...
            String dbpath = null;
            if (oConvertUtils.isNotEmpty(bizPath)) dbpath = bizPath + File.separator + fileName;
            else {
                dbpath = fileName;
            }
