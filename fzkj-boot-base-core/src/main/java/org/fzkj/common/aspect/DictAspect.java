...
import org.fzkj.common.aspect.annotation.Dict;
...
public class DictAspect {
     ...
     * 定义切点Pointcut
     */
    @Pointcut("execution(public * org.fzkj.modules..*.*Controller.*(..)) || @annotation(org.fzkj.common.aspect.annotation.AutoDict)")
